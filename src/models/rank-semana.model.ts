...
@model({
  settings: {idInjection: false, mysql: {schema: 'UCP_PROD', table: 'RANK_SEMANA'}}
})
export class RankSemana extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 10,
  ...
  @property({
    ...
    precision: 10,
    scale: 0,
    mysql: {columnName: 'TS', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'N'},
  })
  ts: number;
  ...
  constructor(data?: Partial<RankSemana>) {
    super(data);
  }
}

export interface RankSemanaRelations {
  // describe navigational properties here
}

export type RankSemanaWithRelations = RankSemana & RankSemanaRelations;
