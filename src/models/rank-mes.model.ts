...
@model({settings: {idInjection: false, mysql: {schema: 'UCP_PROD', table: 'RANK_MES'}}})
export class RankMes extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 10,
  ...
  constructor(data?: Partial<RankMes>) {
    super(data);
  }
}

export interface RankMesRelations {
  // describe navigational properties here
}

export type RankMesWithRelations = RankMes & RankMesRelations;
