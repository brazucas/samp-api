...
@model({settings: {idInjection: false, mysql: {schema: 'UCP_PROD', table: 'RANK_DIA'}}})
export class RankDia extends Entity {
  @property({
    type: 'number',
    required: true,
    precision: 10,
  ...
  constructor(data?: Partial<RankDia>) {
    super(data);
  }
}

export interface RankDiaRelations {
  // describe navigational properties here
}

export type RankDiaWithRelations = RankDia & RankDiaRelations;
